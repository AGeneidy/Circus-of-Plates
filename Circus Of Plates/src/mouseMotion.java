...
public class mouseMotion implements MouseMotionListener, MouseListener {
	...
	public void mouseMoved(MouseEvent e) {
		if (view.mainMenu) {
			if (e.getX() > view.onePlayerButton.getX()
					&& e.getX() < view.onePlayerButton.getX()
							+ view.onePlayerButton.getWidth()
					&& e.getY() > view.onePlayerButton.getY()
					&& e.getY() < view.onePlayerButton.getY()
							+ view.onePlayerButton.getHeight()) {
				view.onePlayerButton.setMouseOnButton(true);
			} else
				view.onePlayerButton.setMouseOnButton(false);

			if (e.getX() > view.twoPlayersButton.getX()
					&& e.getX() < view.twoPlayersButton.getX()
							+ view.twoPlayersButton.getWidth()
					&& e.getY() > view.twoPlayersButton.getY()
					&& e.getY() < view.twoPlayersButton.getY()
							+ view.twoPlayersButton.getHeight()) {
		...
		if (e.getX() > view.exitButton.getX()
				&& e.getX() < view.exitButton.getX()
						+ view.exitButton.getWidth()
				&& e.getY() > view.exitButton.getY()
				&& e.getY() < view.exitButton.getY()
						+ view.exitButton.getHeight()) {
			view.exitButton.setMouseOnButton(true);
		} else
			view.exitButton.setMouseOnButton(false);

		if (e.getX() > view.saveButton.getX()
				&& e.getX() < view.saveButton.getX()
						+ view.saveButton.getWidth()
				&& e.getY() > view.saveButton.getY()
				&& e.getY() < view.saveButton.getY()
						+ view.saveButton.getHeight()) {
			view.saveButton.setMouseOnButton(true);
		} else
			view.saveButton.setMouseOnButton(false);

		if (e.getX() > view.loadButton.getX()
				&& e.getX() < view.loadButton.getX()
						+ view.loadButton.getWidth()
				&& e.getY() > view.loadButton.getY()
				&& e.getY() < view.loadButton.getY()
						+ view.loadButton.getHeight()) {
